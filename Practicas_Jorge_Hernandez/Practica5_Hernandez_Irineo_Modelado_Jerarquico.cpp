...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Hernandez Irineo Jorge Manuel - Modelado jerarquico", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(dedos), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.2f, 0.20f));
		...
		model = glm::rotate(model, glm::radians(dedos2), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.2f, 0.20f));
		...
		model = glm::translate(modelTemp, glm::vec3(0.20f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedos3), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.20f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.20f));
		color = glm::vec3(1.0f, 0.75f, 0.79f);
		...
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.35f, 0.125f));
		model = glm::rotate(model, glm::radians(dedos), glm::vec3(0.0f, 0.0, 1.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.2f, 0.20f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
 ...
 void Inputs(GLFWwindow* window) {
	 ...
	 if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS && dedos < 90.0f)
		 dedos += 0.02f;
	 if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS && dedos > 0.0f)
		 dedos -= 0.02f;
